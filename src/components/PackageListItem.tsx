...
export default function PackageListItem({pack} : PackageListItemProps){
    ...
    return <div key={keyword} className="border py-0.5 px-1 text-xl bg-slate-200 rounded">
      {keyword}
    </div>
    })
   return <div className="p-4 flex border rounded justify-between items-center">
